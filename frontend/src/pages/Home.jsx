        ...
        <div className='flex flex-col lg:flex-row gap-[90px] items-center justify-between'>
          ...
          <div>
            <div className='lg:w-[470px]'>
              ...
              <p className='text__para'>Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Amet alias corrupti officia repellat ullam ad provident fuga veniam
                a quas!Molestias quibusdam assumenda!</p>
          ...
          <div className='flex gap-[30px] justify-end'>
            ...
            <div className='mt-[30px]'>
              <img src={heroImg02} alt="" className='w-[150px] mb-[30px]' />
              <img src={heroImg03} alt="" className='w-[150px]' />
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="container">
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]'>
           ...
           <div className='mt-[30px]'>
                ...
                <Link to='/docotrs' className='w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] mt-[30px] mx-auto flex items-center justify-center group hover:bg-primaryColor hover:border-none'
           ...
           <div className='mt-[30px]'>
                ...
                >
                 <BsArrowRight className='group-hover:text-white w6 h-5'/>
                </Link>
            </div>
            </div>
            ...
            <div className='xl:w-[670px]'>
              ...
              <ul className='pl-4'>
                <li className="text__para">
                  1. Schedule the appointment directley.
                </li>
                <li className='text__para'>2. Search for your physician here, and contact their office.</li>
                <li className="text__para">3. View our physician who are accepting new patients, use the
            ...
            <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
              ...
              <div className="w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-[16px] lg:gap-3">
                ...
                <div className="flex items-center gap-[6px] lg:gap-[10px] mt-2 lg:mt-[18px]">
                  ...
                  <h2 className='text-[10px] leading-3 lg:text-[16px] lg:leading-[22px] font-[700] text-headingColor'>Wayne Collins</h2>
                </div>
